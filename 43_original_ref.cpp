...
방법: 앞에서부터 차곡차곡 최대로 채우는 것 (lecture idea)
예를 들어 1~9분짜리의 곡을 수록한다면 총 45분이므로 
개수에 따라 최소 1부터 최대 45분 크기의 DVD에 넣을 수 있다.

이때 1부터 45분까지 순서대로 확인할 수도 있지만 이분 검색을 결정 알고리즘에
활용하여 답을 빠르게 얻을 수 있다.(lecture idea)
*/
